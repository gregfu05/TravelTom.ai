"""API request and response schemas for recommendations endpoints."""
...
class RecommendationQuery(BaseModel):
    """Input payload for the recommendations query endpoint."""
...
class RecommendationResponse(BaseModel):
    """Response payload for the recommendations query endpoint."""
