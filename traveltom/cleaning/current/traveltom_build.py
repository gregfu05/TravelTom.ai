...
CITIES = {
    ...
    "London": {
        ...
        "cont": "Europe",
        "st": "England",
        "bb": (51.28, -0.51, 51.69, 0.33),
    },
    "Paris": {
        "cc": "FR",
        "cont": "Europe",
        "st": "Île-de-France",
        "bb": (48.81, 2.22, 48.90, 2.47),
    },
    "Rome": {
        "cc": "IT",
        "cont": "Europe",
        "st": "Lazio",
        "bb": (41.79, 12.37, 41.99, 12.60),
    },
    "Barcelona": {
        "cc": "ES",
        "cont": "Europe",
        "st": "Catalonia",
        "bb": (41.32, 2.05, 41.47, 2.23),
    },
    "Amsterdam": {
        "cc": "NL",
        "cont": "Europe",
        "st": "North Holland",
        "bb": (52.33, 4.77, 52.43, 4.98),
    },
    "Prague": {
        "cc": "CZ",
        "cont": "Europe",
        "st": "Prague",
        "bb": (50.00, 14.30, 50.14, 14.55),
    },
    "Vienna": {
        "cc": "AT",
        "cont": "Europe",
        "st": "Vienna",
        "bb": (48.12, 16.20, 48.32, 16.50),
    },
    "Berlin": {
        "cc": "DE",
        "cont": "Europe",
        "st": "Berlin",
        "bb": (52.39, 13.23, 52.62, 13.55),
    },
    "Istanbul": {
        "cc": "TR",
        "cont": "Europe",
        "st": "Istanbul",
        "bb": (40.88, 28.63, 41.20, 29.35),
    },
    "Lisbon": {
        "cc": "PT",
        "cont": "Europe",
        "st": "Lisbon",
        "bb": (38.69, -9.23, 38.80, -9.09),
    },
    "Madrid": {
        "cc": "ES",
        "cont": "Europe",
        "st": "Madrid",
        "bb": (40.33, -3.83, 40.53, -3.58),
    },
    "Athens": {
        "cc": "GR",
        "cont": "Europe",
        "st": "Attica",
        "bb": (37.90, 23.68, 38.05, 23.80),
    },
    "Dublin": {
        "cc": "IE",
        "cont": "Europe",
        "st": "Leinster",
        "bb": (53.28, -6.39, 53.41, -6.11),
    },
    "Budapest": {
        "cc": "HU",
        "cont": "Europe",
        "st": "Budapest",
        "bb": (47.43, 19.00, 47.56, 19.15),
    },
    "Edinburgh": {
        "cc": "GB",
        "cont": "Europe",
        "st": "Scotland",
        "bb": (55.90, -3.30, 55.98, -3.10),
    },
    "Florence": {
        "cc": "IT",
        "cont": "Europe",
        "st": "Tuscany",
        "bb": (43.74, 11.20, 43.80, 11.30),
    },
    "Munich": {
        "cc": "DE",
        "cont": "Europe",
        "st": "Bavaria",
        "bb": (48.06, 11.45, 48.22, 11.68),
    },
    "Copenhagen": {
        "cc": "DK",
        "cont": "Europe",
        "st": "Capital Region",
        "bb": (55.63, 12.47, 55.73, 12.63),
    },
    "Stockholm": {
        "cc": "SE",
        "cont": "Europe",
        "st": "Stockholm",
        "bb": (59.28, 17.94, 59.40, 18.16),
    },
    "Milan": {
        "cc": "IT",
        "cont": "Europe",
        "st": "Lombardy",
        "bb": (45.40, 9.10, 45.52, 9.28),
    },
    "Porto": {
        "cc": "PT",
        "cont": "Europe",
        "st": "Porto",
        "bb": (41.12, -8.68, 41.19, -8.57),
    },
    "Seville": {
        "cc": "ES",
        "cont": "Europe",
        "st": "Andalusia",
        "bb": (37.33, -6.02, 37.42, -5.90),
    },
    # ── Asia (17) ──
    "Tokyo": {
        "cc": "JP",
        "cont": "Asia",
        "st": "Tokyo",
        "bb": (35.55, 139.55, 35.82, 139.90),
    },
    "Bangkok": {
        "cc": "TH",
        "cont": "Asia",
        "st": "Bangkok",
        "bb": (13.60, 100.35, 13.95, 100.75),
    },
    "Singapore": {
        "cc": "SG",
        "cont": "Asia",
        "st": "Singapore",
        "bb": (1.22, 103.60, 1.47, 104.00),
    },
    "Hong Kong": {
        "cc": "HK",
        "cont": "Asia",
        "st": "Hong Kong",
        "bb": (22.15, 113.83, 22.56, 114.35),
    },
    "Seoul": {
        "cc": "KR",
        "cont": "Asia",
        "st": "Seoul",
        "bb": (37.42, 126.80, 37.70, 127.15),
    },
    "Kuala Lumpur": {
        "cc": "MY",
        "cont": "Asia",
        "st": "KL",
        "bb": (3.05, 101.60, 3.20, 101.78),
    },
    "Bali": {
        "cc": "ID",
        "cont": "Asia",
        "st": "Bali",
        "bb": (-8.85, 114.43, -8.06, 115.71),
    },
    "Delhi": {
        "cc": "IN",
        "cont": "Asia",
        "st": "Delhi",
        "bb": (28.40, 76.84, 28.88, 77.35),
    },
    "Mumbai": {
        "cc": "IN",
        "cont": "Asia",
        "st": "Maharashtra",
        "bb": (18.89, 72.77, 19.27, 72.98),
    },
    "Kyoto": {
        "cc": "JP",
        "cont": "Asia",
        "st": "Kyoto",
        "bb": (34.93, 135.70, 35.08, 135.82),
    },
    "Shanghai": {
        "cc": "CN",
        "cont": "Asia",
        "st": "Shanghai",
        "bb": (31.00, 121.20, 31.40, 121.80),
    },
    "Beijing": {
        "cc": "CN",
        "cont": "Asia",
        "st": "Beijing",
        "bb": (39.75, 116.20, 40.02, 116.55),
    },
    "Hanoi": {
        "cc": "VN",
        "cont": "Asia",
        "st": "Hanoi",
        "bb": (20.98, 105.75, 21.08, 105.88),
    },
    "Taipei": {
        "cc": "TW",
        "cont": "Asia",
        "st": "Taipei",
        "bb": (24.96, 121.45, 25.11, 121.61),
    },
    "Chiang Mai": {
        "cc": "TH",
        "cont": "Asia",
        "st": "Chiang Mai",
        "bb": (18.74, 98.94, 18.82, 99.02),
    },
    "Dubai": {
        "cc": "AE",
        "cont": "Asia",
        "st": "Dubai",
        "bb": (25.05, 55.10, 25.35, 55.40),
    },
    "Amman": {
        "cc": "JO",
        "cont": "Asia",
        "st": "Amman",
        "bb": (31.90, 35.85, 31.99, 35.98),
    },
    # ── Americas (14) ──
    "New York": {
        "cc": "US",
        "cont": "North America",
        "st": "NY",
        "bb": (40.49, -74.26, 40.92, -73.70),
    },
    "Los Angeles": {
        "cc": "US",
        "cont": "North America",
        "st": "CA",
        "bb": (33.70, -118.67, 34.34, -118.15),
    },
    "San Francisco": {
        "cc": "US",
        "cont": "North America",
        "st": "CA",
        "bb": (37.70, -122.52, 37.83, -122.35),
    },
    "Miami": {
        "cc": "US",
        "cont": "North America",
        "st": "FL",
        "bb": (25.70, -80.30, 25.86, -80.13),
    },
    "Mexico City": {
        "cc": "MX",
        "cont": "North America",
        "st": "CDMX",
        "bb": (19.28, -99.25, 19.50, -99.05),
    },
    "Cancun": {
        "cc": "MX",
        "cont": "North America",
        "st": "Q.Roo",
        "bb": (21.05, -86.88, 21.20, -86.74),
    },
    "Toronto": {
        "cc": "CA",
        "cont": "North America",
        "st": "ON",
        "bb": (43.58, -79.64, 43.86, -79.12),
    },
    "Vancouver": {
        "cc": "CA",
        "cont": "North America",
        "st": "BC",
        "bb": (49.20, -123.27, 49.32, -123.02),
    },
    "Buenos Aires": {
        "cc": "AR",
        "cont": "South America",
        "st": "CABA",
        "bb": (-34.70, -58.53, -34.53, -58.33),
    },
    "Rio de Janeiro": {
        "cc": "BR",
        "cont": "South America",
        "st": "RJ",
        "bb": (-23.08, -43.48, -22.85, -43.17),
    },
    "Lima": {
        "cc": "PE",
        "cont": "South America",
        "st": "Lima",
        "bb": (-12.20, -77.15, -12.00, -76.90),
    },
    "Bogota": {
        "cc": "CO",
        "cont": "South America",
        "st": "Bogota",
        "bb": (4.52, -74.20, 4.80, -74.00),
    },
    "Cusco": {
        "cc": "PE",
        "cont": "South America",
        "st": "Cusco",
        "bb": (-13.55, -72.00, -13.49, -71.94),
    },
    "Havana": {
        "cc": "CU",
        "cont": "North America",
        "st": "Havana",
        "bb": (23.08, -82.45, 23.17, -82.33),
    },
    # ── Africa (5) ──
    "Cape Town": {
        "cc": "ZA",
        "cont": "Africa",
        "st": "W. Cape",
        "bb": (-34.15, 18.35, -33.85, 18.70),
    },
    "Cairo": {
        "cc": "EG",
        "cont": "Africa",
        "st": "Cairo",
        "bb": (29.95, 31.17, 30.13, 31.40),
    },
    "Nairobi": {
        "cc": "KE",
        "cont": "Africa",
        "st": "Nairobi",
        "bb": (-1.37, 36.70, -1.18, 36.92),
    },
    "Marrakech": {
        "cc": "MA",
        "cont": "Africa",
        "st": "Marrakech",
        "bb": (31.58, -8.05, 31.67, -7.95),
    },
    "Johannesburg": {
        "cc": "ZA",
        "cont": "Africa",
        "st": "Gauteng",
        "bb": (-26.33, 27.92, -26.10, 28.15),
    },
    # ── Oceania (3) ──
    "Sydney": {
        "cc": "AU",
        "cont": "Oceania",
        "st": "NSW",
        "bb": (-33.95, 151.05, -33.75, 151.30),
    },
    "Melbourne": {
        "cc": "AU",
        "cont": "Oceania",
        "st": "VIC",
        "bb": (-37.87, 144.89, -37.74, 145.05),
    },
    "Auckland": {
        "cc": "NZ",
        "cont": "Oceania",
        "st": "Auckland",
        "bb": (-36.94, 174.70, -36.82, 174.85),
    },
}
...
def stage_download():
    ...
    for slug in KAGGLE_DATASETS:
        ...
        try:
            ...
            total = sum(
                sum(1 for _ in open(f, encoding="utf-8", errors="ignore")) - 1
                for f in csvs
            )
...
def read_dir(slug: str) -> pd.DataFrame:
    ...
    for f in d.glob("*.csv"):
        try:
            ...
            try:
                df = pd.read_csv(
                    f, low_memory=False, on_bad_lines="skip", encoding="latin-1"
                )
                df.columns = [c.strip().lower().replace(" ", "_") for c in df.columns]
                frames.append(df)
            except Exception:
    ...
    for f in d.glob("*.csv"):
        try:
            for chunk in pd.read_csv(
                ...
                sub = pd.DataFrame(
                    {
                        "name": chunk.get("hotelname", pd.Series(dtype=str))
                        .astype(str)
                        .str.strip(),
                        "city": chunk.get("cityname", pd.Series(dtype=str))
                        .astype(str)
                        .str.strip(),
                        "country": chunk.get(
                            "countycode", chunk.get("countrycode", pd.Series(dtype=str))
                        )
                        .astype(str)
                        .str.strip(),
                        "country_name": chunk.get(
                            "countyname", chunk.get("countryname", pd.Series(dtype=str))
                        )
                        .astype(str)
                        .str.strip(),
                        "latitude": chunk["_lat"],
                        ...
                        "stars": pd.to_numeric(
                            chunk.get("hotelrating", pd.Series(dtype=float)),
                            errors="coerce",
                        ),
                        "review_count": 0,
                        "categories": "hotel;lodging",
                        "address": chunk.get("address", pd.Series(dtype=str))
                        .astype(str)
                        .str.strip()
                        .str[:500],
                        "description": chunk.get("description", pd.Series(dtype=str))
                        .astype(str)
                        .str.strip()
                        .str[:1000],
                        "phone": chunk.get("phonenumber", pd.Series(dtype=str))
                        .astype(str)
                        .str.strip(),
                        "website": chunk.get("hotelwebsiteurl", pd.Series(dtype=str))
                        .astype(str)
                        .str.strip(),
                        "source": "tbo_hotels",
                        "entity_type": "hotel",
                ...
                sub = sub[
                    sub["name"].notna() & (sub["name"] != "") & (sub["name"] != "nan")
                ]
        ...
        rows.append(
            {
                ...
                "website": (
                    str(r.get("url", "")) if not pd.isna(r.get("url", np.nan)) else ""
                ),
                "source": "michelin",
...
def norm_tripadvisor() -> list[dict]:
    ...
    for _, r in df.iterrows():
        ...
        reviews = (
            r.get("total_reviews") or r.get("review_count") or r.get("num_reviews", 0)
        )
        city = r.get("city", "")
        ...
        rows.append(
            {
                ...
                "review_count": (
                    int(float(reviews)) if reviews and not pd.isna(reviews) else 0
                ),
                "categories": ";".join(cats),
                "source": "tripadvisor",
                "entity_type": "restaurant",
...
def norm_destinations() -> list[dict]:
    ...
    for _, r in df.iterrows():
        ...
        cat = (
            str(r.get("type") or r.get("category", "")).lower()
            if not pd.isna(r.get("type", r.get("category", np.nan)))
            else "attraction"
        )
        ...
        visitors = (
            r.get("annual_visitors_(m)")
            or r.get("annual_visitors")
            or r.get("visitors", 0)
        )
        cost = (
            r.get("avg_cost_(usd/day)")
            or r.get("avg_cost_($)")
            or r.get("avg_cost")
            or r.get("cost")
        )
        ...
        etype = "attraction"
        if cat in ["beach", "nature", "adventure"]:
            etype = "activity"
        elif cat in ["city"]:
            etype = "attraction"
        ...
        if season and not pd.isna(season):
            attrs["best_season"] = str(season)
        unesco = r.get("unesco_site") or r.get("unesco", "")
        if unesco and not pd.isna(unesco):
            attrs["unesco"] = str(unesco)

        rows.append(
            {
                "name": str(name).strip(),
                "country_name": (
                    str(country).strip() if country and not pd.isna(country) else ""
                ),
                "continent": str(cont).strip() if cont and not pd.isna(cont) else "",
                "stars": float(rating) if rating and not pd.isna(rating) else np.nan,
                "review_count": (
                    int(float(visitors)) if visitors and not pd.isna(visitors) else 0
                ),
...
def norm_global_attractions() -> list[dict]:
    ...
    for slug, tag in [
        ...
        for _, r in df.iterrows():
            ...
            reviews = (
                r.get("review_count") or r.get("reviews") or r.get("num_reviews", 0)
            )
            ...
            rows.append(
                {
                    ...
                    "longitude": float(lon) if lon and not pd.isna(lon) else np.nan,
                    "stars": (
                        float(rating) if rating and not pd.isna(rating) else np.nan
                    ),
                    "review_count": (
                        int(float(reviews)) if reviews and not pd.isna(reviews) else 0
                    ),
                    "categories": (
                        f"attraction;{str(cat).lower().strip()}"
                        if cat and not pd.isna(cat)
                        else "attraction"
                    ),
                    "description": (
                        str(desc).strip()[:1000] if desc and not pd.isna(desc) else ""
                    ),
                    "source": tag,
...
def parse_osm_element(el: dict, city: str, meta: dict, etype: str) -> dict:
    ...
    stars = (
        float(osm_stars)
        if osm_stars and osm_stars.replace(".", "").isdigit()
        else np.nan
    )
...
def stage_cities_meta() -> pd.DataFrame:
    ...
    try:
        ...
        enrich = (
            pd.DataFrame.from_dict(cmap, orient="index")
            .reset_index()
    ...
    if len(wc) > 0:
        name_col = next(
            (c for c in wc.columns if c in ["city", "name", "city_ascii"]), None
        )
        ...
        if name_col and pop_col:
            ...
            lookup = dict(
                wc.sort_values(pop_col, ascending=False)
                .drop_duplicates("_k")[["_k", pop_col]]
                .values
            )
...
def stage_merge(kaggle_df: pd.DataFrame, osm_df: pd.DataFrame) -> pd.DataFrame:
    ...
    if len(df_c) > 0:
        ...
        before2 = len(df_c)
        df_c = df_c.sort_values("_priority").drop_duplicates(
            ["_name_key", "_lr", "_lnr"], keep="first"
        )
