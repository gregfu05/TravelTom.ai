...
GEO_COLS = [
    "business_id", "name", "city", "state", "country",
    "country_name", "continent", "latitude", "longitude", "entity_type"
]

RATING_COLS = [
    "business_id", "name", "stars", "review_count",
    "popularity", "source", "entity_type", "city", "continent", "hours"
]

CATEGORY_COLS = [
    "business_id", "name", "categories", "attributes",
    "description", "entity_type", "price_level", "stars"
]
